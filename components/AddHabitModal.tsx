...
export default function AddHabitModal({ isVisible, onClose, onAdd }: AddHabitModalProps) {
    ...
    <Modal animationType="slide" transparent={true} visible={isVisible} onRequestClose={onClose}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={tw`flex-1 justify-end`}>
        <View style={tw`bg-gray-800 rounded-t-3xl p-6`}>
          <Text style={tw`text-white text-2xl font-bold mb-4`}>Add New Habit</Text>
          ...
          <TouchableOpacity style={tw`bg-violet-600 p-4 rounded-lg mb-4`} onPress={handleAdd}>
            <Text style={tw`text-white text-center font-bold`}>Add Habit</Text>
          </TouchableOpacity>
